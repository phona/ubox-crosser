...
build: $(SOURCES)
	...
	CGO_ENABLED=0 go build $(GO_LDFLAGS) -o bin/client ./cmd/client
	CGO_ENABLED=0 go build $(GO_LDFLAGS) -o bin/server ./cmd/server
	CGO_ENABLED=0 go build $(GO_LDFLAGS) -o bin/auth_server ./cmd/auth_server
