...
#### Scenario: UBOX-S7 git_sha reflects ldflags injection
- **GIVEN** the server is built with -X main.GitSHA=abc1234
- **WHEN** a client sends GET /buildinfo
- **THEN** the response JSON field git_sha equals "abc1234"
