# REQ-final12-1776969734 Tasks

## Stage: contract / spec

- [x] author specs/buildinfo-endpoint/contract.spec.yaml with OpenAPI 3.0 schema
- [x] author specs/buildinfo-endpoint/spec.md with 7 UBOX-S scenarios in openspec delta format
...
- [x] git push feat/REQ-final12-1776969734
- [x] gh pr create
