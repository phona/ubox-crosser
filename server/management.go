...
// ManagementServer serves HTTP management endpoints (/healthz, /buildinfo).
...
func (ms *ManagementServer) handleHealthz(w http.ResponseWriter, _ *http.Request) {
...
func (ms *ManagementServer) handleBuildinfo(w http.ResponseWriter, _ *http.Request) {
...
func (ms *ManagementServer) ListenAndServe(addr string) error {
	return http.ListenAndServe(addr, ms.mux) //nolint:gosec
}
